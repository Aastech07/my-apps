...
import { ScrollView, Text, View,TouchableOpacity,Modal,StyleSheet,Image,Pressable,TextInput } from 'react-native';
...
const Announcement = () => {
  ...
  const [value, onChangeText] = React.useState('Add Description..');
  ...
  const handleDateChange = (event, selectedDate) => {
    if (selectedDate !== undefined) {
      setCompletionYear(selectedDate);
    }
  };
...
<ScrollView style={{flex:1,backgroundColor:'#fff'}} contentContainerStyle={{paddingBottom:150}}>
   ...
   <View style={{ top: 60,left:20 }}>
    ...
    <View style={{top:30,alignItems:"center"}}>
     <Text style={{fontSize:responsiveFontSize(3),fontWeight:'400'}}>Add <Text style={{fontWeight:'300',color:'tomato'}}>Announcement</Text></Text>
    </View>
...
<View style={{ bottom:responsiveHeight(14) }}>
              <Text
                style={{
      ...
      style={{
        ...
        marginHorizontal:20,
        top:80,
        borderWidth:1,borderRadius:8,opacity:0.5
      }}>
