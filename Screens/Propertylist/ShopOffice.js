...
const ShopOffice = () => {
  ...
  const PropertyFor = [
    { key: "1", value: "For Rent: Shops & Offices" },
    { key: "2", value: "For Sale: Shops & Offices" },
    { key: "3", value: "Other" },
  ];
  ...
  useEffect(() => {
    const getproperties = async () => {
      try {
        const { data } = await axios.get(`${api}/shopOffices/${id}`);
        setAddress(data.address);
        setLandmark(data.landmark);
        setPropertyFor(data.shopOfficeType);
        ...
        setPrice(data.price);
        setMaintenance(data.maintenance); // Corrected capitalization
        setWashrooms(data.washrooms); // Corrected function name
  ...
  const UpdateForm = async () => {
    try {
      const { data } = await axios.put(`${api}/shopOffices/${id}`, {
              ...
              <View style={{ bottom: 140 }}>
                ...
                <View style={styles.inputView}>
                  <TextInput
                    ...
                    placeholder="Carpet Area"
                    placeholderTextColor="black"
                    onChangeText={(txt) => SetMaintenance(txt)}
                    value={maintenance}
                    keyboardType="numeric"
                  />
                </View>
              ...
              <View style={{ bottom: 140 }}>
                ...
                <View style={styles.inputView}>
                  <TextInput
                    ...
                    placeholder="Carpet Area"
                    placeholderTextColor="black"
                    onChangeText={(txt) => SetWashrooms(txt)}
                    value={washrooms}
                    keyboardType="numeric"
                  />
                </View>
