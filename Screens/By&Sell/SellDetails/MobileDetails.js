...
const MobileDetails = () => {
  ...
  return (
    ...
    </View><Alerts visible={visible} onClose={onClose} icon={"mobile"} title={'Application Submitted'} desc={"The Request For The Mobile Has Been Sent Successfully!"} /></>
  );
};
