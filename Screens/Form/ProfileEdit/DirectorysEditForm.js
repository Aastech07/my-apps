...
const DirectorysEditForm = () => {
  ...
  const PostDirectory = async () => {
    ...
    try {
      ...
      console.log("Error during Description Edit:", error.message);
    }
  };
      ...
      >
        <View style={{ flex: 1 }}>
          <View style={{ bottom: 10 }}>
            ...
            <View style={{ top: -38, alignItems: "center", left: 10 }}>
...
export default DirectorysEditForm;
